...
# 西蒙学习法
  ...
  * 每个学科权重知识=50000
  * 1分1个知识=5个月一个学科
  * 默认模式网络+注意力网络+权重排序+注意力权重排序
  * 卡片大法
  * 大脑爱对比、脑补、提问、mvp、最小模式、行动的意义，
  * 45分钟休息17分钟
  * 记录休息权重方法论
  * 内在动机测试模型
  * 食物
  ...
  * 始终保持在做最重要的事情。
  * 专攻一个领域
  * 先去检测一下自己的程度 学习率「15.87%」然后再主动去学习。
  * 大脑擅长{{c1::辨认}}却不擅长{{c1::回忆}}，因此用尝试{{c1::主动锻炼回忆}}。用anki
  * 6小时后用自己的话表达每一个知识卡片
  * 对卡片CRUD 勤问并及时{{c1::改正、强化、教、问}}学习的知识，及时{{c1::更新}}笔记，以巩固知识的理解。
  * 记忆法来加强记忆。「首字缩略法」、「意象联想」、「记忆宫殿」
  * 创造专属的{{c1::学习空间}}：脑中会下意识的{{c1::开启学习状态}}，空间:书房、图书馆
